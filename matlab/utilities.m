...
classdef utilities
    ...
    methods
        function ax_cells = plotResults(obj, varargin)
            ...
            if isempty(legend_texts) || (isfield(legend_texts,'String') && isempty(legend_texts.String))
...
%                 legend(ax_cells{3}(1), strings{:});            
        ...
        %
        function selected_time = select_time_vector(~, varargin)
        ...
        function animateResults(obj, varargin)
            ...
            if args.plot
                ...
                car_profile = carProf(obj,args.parameters(2),0.5*args.parameters(2));
        ...
        %
        function [ax] = plotGraph(~,varargin)
        ...
        function printLabeledAB(obj, varargin)
            ...
            printJointAB(obj, args.matrix_A, args.matrix_B);
        end
        %
        function printRelativeError(obj, varargin)
            ...
            printLabeledAB(obj, errorA, errorB, args.matrix_label, 'description', args.description);
        end        
        %
        ...
        %
        function printComplexNumbers(~, varargin)
        ...
        %
        function simulate_flag = solutionImplemented(~, function_output, function_name, simulate_flag)
        ...
        %
        function XY_position = SDCoordToXY(~, path_to_track, s_coord, d_coord)
        ...
        %
        function varargout = obtainMinimumPotentialPath(~, varargin)
